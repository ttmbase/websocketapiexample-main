...
module.exports = class TtmBaseSocketClient extends EventEmitter {

    constructor( apiKey, secretKey, wssHost = "wss://ws.ttmbase.com") {
    
    	super();
    	
        this._apiKey = apiKey;
        this._secretKey = secretKey;
        this._wssHost = wssHost || "wss://ws.ttmbase.com";
